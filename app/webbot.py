...
def play_options_keyboard(update: Update) -> InlineKeyboardMarkup:
    ...
    for game_type in game_types:
        keyboard.append([InlineKeyboardButton(f"🎮 Play {game_type['bet_amount']}", web_app=WebAppInfo(url=f"https://liyuchawata.com/bingo/?playerId={update.effective_user.id}&betAmount={game_type['bet_amount']}&playerName={update.effective_user.username}"))])
