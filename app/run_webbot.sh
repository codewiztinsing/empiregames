...
# Empire Games Web Bot - PM2 Management Script
...
start_bot() {
    ...
    pm2 start webbot.py \
        ...
        --log "$LOG_DIR/webbot.log" \
        --error "$LOG_DIR/webbot-error.log" \
        --out "$LOG_DIR/webbot-out.log" \
        --merge-logs \
...
# Show help
show_help() {
    echo "Empire Games Web Bot - PM2 Management Script"
    echo ""
